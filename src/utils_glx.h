...
int
gl_vdpau_init(GLintptr device, void *get_proc_address);
...
GLVdpSurface *
gl_vdpau_create_video_surface(GLenum target, GLintptr surface);

GLVdpSurface *
gl_vdpau_create_output_surface(GLenum target, GLintptr surface);
